...
0. **Sector setup.** Read `estimating/reference/sector-tenant-improvement.md` yourself, and pass its path to EVERY subagent
...
`python3 estimating/scripts/validate_estimate.py <project_dir>/ --sector ti`
