...
`python3 resources/build_loan_package_xlsx.py <project_dir>/`
(resolve `resources/` against this skill's own folder; config: copy
`resources/loan-package-config.template.json` into
