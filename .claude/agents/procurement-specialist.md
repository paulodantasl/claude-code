...
1. Read the shared knowledge base:
   - `estimating/reference/florida-code.md` (NOA vs FL# product approval, HVHZ, termite, soils)
   - `estimating/reference/csi-divisions.md` (what each division actually buys)
   - `estimating/reference/estimating-methodology.md` (units, waste, budgetary ranges for sanity-checking)
   - `estimating/templates/procurement-template.md` (your output format + the price-provenance legend)
...
## Output
- Write `procurement.md` in the project folder using `estimating/templates/procurement-template.md`
