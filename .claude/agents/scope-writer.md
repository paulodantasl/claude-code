...
## Before you start
1. Read `estimating/reference/csi-divisions.md` (especially the **scope-gap checklist**),
   `estimating/reference/florida-code.md`, and `estimating/templates/scope-of-work-template.md`.
