...
Read `${CLAUDE_PLUGIN_ROOT}/reference/takeoff-accuracy-protocol.md` and follow it as a hard gate — it encodes real
...
`${CLAUDE_PLUGIN_ROOT}/scripts/jobtread_takeoff.py`. Overlay-verify geometry on the sheet BEFORE saving; record a
