...
| [construction-estimating](./construction-estimating/) | Florida construction takeoff, scope of work, cost estimating, bid proposals, independent QA audit, and bank construction-loan packages | **Commands:** `/bid` (+ `/bid-public`, `/bid-residential`, `/bid-commercial`, `/bid-ti`) and per-stage `/takeoff`, `/scope`, `/estimate`, `/proposal`, `/audit`, `/procure`, `/loan-package`<br>**Agents:** `takeoff-engineer`, `scope-writer`, `cost-estimator`, `bid-proposal-writer`, `estimate-auditor`, `procurement-specialist`<br>**Skills:** 8 skills covering takeoff, estimating, audit, procurement, and 4 market sectors |
