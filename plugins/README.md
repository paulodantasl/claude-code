...
| [construction-estimating](./construction-estimating/) | Florida preconstruction: takeoff, scope, estimate, proposal, audit, loan packages (Ideal Construction) | **Commands:** `/bid` + 4 sector variants, `/loan-package`<br>**Agents:** 6 specialists<br>**Skills:** 8 Cowork-deployable skills + Claude.ai chat package |
